...
message("TF2PL CMAKE_BUILD_TYPE = ${CMAKE_BUILD_TYPE}")

if ("${TF2BD_VERSION_BUILD}" STREQUAL "")
	set(TF2BD_VERSION_BUILD 0)
endif()

set(TF2BD_VERSION_NOBUILD "${TF2BD_VERSION_MAJOR}.${TF2BD_VERSION_MINOR}.${TF2BD_VERSION_PATCH}" CACHE STRING "TF2PL version without the build number" FORCE)
set(TF2BD_VERSION "${TF2BD_VERSION_NOBUILD}.${TF2BD_VERSION_BUILD}" CACHE STRING "Full TF2PL version string" FORCE)
...
message("TF2PL CMAKE_PROJECT_VERSION = ${CMAKE_PROJECT_VERSION}")
